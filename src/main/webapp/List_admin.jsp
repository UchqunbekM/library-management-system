...
<div class="card">
    ...
    <div class="button-container"><span><a href="sup_panel.html">Super_Adm's panel </a></span>
        ...
        <table>
            ...
            <c:forEach var="adminlist" items="${list}">
                <tr>
                    ...
                    <td><strong></strong>${adminlist.name}</td>
                    <td>${adminlist.password}</td>
                    <td>${adminlist.email}</td>
                    <td class="danger">
                        <button class="danger"><a href="deleteadmin?id=${adminlist.id}"> Delete</a></button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
